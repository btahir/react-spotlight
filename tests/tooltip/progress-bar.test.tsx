...
describe('ProgressBar', () => {
  it('renders with correct width percentage', () => {
    ...
    const { container } = render(
      <ProgressBar current={1} total={4} theme={lightTheme} />,
    )
  ...
  it('renders 100% on last step', () => {
    ...
    const { container } = render(
      <ProgressBar current={3} total={4} theme={lightTheme} />,
    )
  ...
  it('renders 0% when total is 0', () => {
    const { container } = render(
      <ProgressBar current={0} total={0} theme={lightTheme} />,
    )
  ...
  it('applies theme styles', () => {
    const { container } = render(
      <ProgressBar current={0} total={3} theme={lightTheme} />,
    )
